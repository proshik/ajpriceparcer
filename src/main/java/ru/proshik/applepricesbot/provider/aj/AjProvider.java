package ru.proshik.applepricesbot.provider.aj;
...
import static ru.proshik.applepricesbot.utils.ProviderUtils.extractParameters;

public class AjProvider implements Provider {

    private static final Logger LOG = Logger.getLogger(ru.proshik.applepricesbot.provider.aj.AjProvider.class);
